...
import 'package:bamtol_market_study/src/common/components/place_name_popup.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  return FlutterMap(
                    ...
                    //               Get.back(result: {
                    //                 'label': result,
                    //                 'location': _mapController
                    //                     .camera.center //_mapController.center
                    //               });
                    //             },
                    //             child: const AppFont(
                    //               '선택 완료',
...
class SimpleTradeLocationMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlutterMap(
      options: MapOptions(
        initialCenter: myLocation, //center: myLocation,
